...
class Container_78eb617eb3 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'Drahak\Restful\Application\UI\ResourcePresenter' => [1 => ['application.4']],
			'Drahak\Restful\Application\IResourcePresenter' => [1 => ['application.4']],
	...
	{
		return new Container_78eb617eb3_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_78eb617eb3_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_78eb617eb3 $container)
	{
